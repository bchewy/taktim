...
class AuditTrailGeneratorTool(BaseTool):
    """Tool for generating auditable compliance evidence"""
    
    name: str = "audit_trail_generator"
    description: str = """Generate comprehensive audit trail for regulatory compliance screening.
    ...
    def _run(self, feature_data: str, compliance_analysis: str) -> str:
...
class GeoRegulatoryAgent:
    ...
    def __init__(self):
        ...
        # Initialize tools
        self.geo_compliance_tool = GeoComplianceMappingTool()
        self.audit_trail_tool = AuditTrailGeneratorTool()
    ...
    def _create_agent(self) -> Agent:
        ...
        return Agent(
            ...
            tools=[self.geo_compliance_tool, self.audit_trail_tool],
            llm=self.llm,
            verbose=True,
