        ...
        <div>
            <div className="mb-8">
                ...
                <p className="text-gray-600">
                    Analyze a TikTok feature for geo-specific compliance
                    requirements
                </p>
            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-6 border border-blue-200 rounded-lg bg-blue-50">
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold text-blue-900">{result.feature_analyzed}</p>
                                    </div>
                                    <div>
                                        <span className="text-sm font-medium text-blue-700">Analysis Type:</span>
                            ...
                            {result.result?.legal_research && (
                                <div className="border border-yellow-200 rounded-lg bg-yellow-50">
                                    <button
                                        className="w-full p-6 text-left focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-inset rounded-t-lg"
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <svg 
                                                className={`w-5 h-5 text-yellow-700 transition-transform duration-200 ${accordionState.legalResearch ? 'rotate-180' : ''}`} 
                                                fill="none" 
                                                stroke="currentColor" 
                                                viewBox="0 0 24 24"
                                            >
                                    ...
                                    {accordionState.legalResearch && (
                                        <div className="px-6 pb-6 space-y-4">
                                            ...
                                            <div className="bg-white border border-yellow-300 rounded-lg p-4">
                                                <h5 className="font-semibold text-gray-900 mb-2">Legal Review Scope</h5>
                                            ...
                                            {/* Legal Citations */}
                                            <div className="bg-white border border-yellow-300 rounded-lg p-4">
                                                <h5 className="font-semibold text-gray-900 mb-2">Legal Citations & Sources</h5>
                                                    ...
                                                    {result.result.legal_research.citations ? (
                                                        ...
                                                        <div className="space-y-2">
                                                            <div className="flex items-start">
                                                                <span className="text-blue-600 mr-2">•</span>
                                                                <a href="https://www.govinfo.gov" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">
                                                                    GovInfo.gov - Federal Register and Regulatory Information
                                                                </a>
                                                            </div>
                                                            <div className="flex items-start">
                                                                <span className="text-blue-600 mr-2">•</span>
                                                                <a href="https://www.congress.gov" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">
                                                                    Congress.gov - Legislative Information System
                                                                </a>
                                                            </div>
                                                            <div className="flex items-start">
                                                                <span className="text-blue-600 mr-2">•</span>
                                                                <a href="https://www.ftc.gov/legal-library/browse/rules/childrens-online-privacy-protection-rule-coppa" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">
                                                                    FTC.gov - Children's Online Privacy Protection Act (COPPA)
                                                                </a>
                                                            </div>
                                                            <div className="flex items-start">
                                                                <span className="text-blue-600 mr-2">•</span>
                                                                <a href="https://www.ecfr.gov" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">
                            ...
                            {result.result?.geo_regulatory_mapping && (
                                <div className="bg-white border border-gray-200 rounded-lg">
                                    <button
                                        className="w-full p-6 text-left focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-inset rounded-t-lg"
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <svg 
                                                className={`w-5 h-5 text-gray-700 transition-transform duration-200 ${accordionState.geoRegulatory ? 'rotate-180' : ''}`} 
                                                fill="none" 
                                                stroke="currentColor" 
                                                viewBox="0 0 24 24"
                                            >
                                    ...
                                    {accordionState.geoRegulatory && (
                                        <div className="px-6 pb-6 space-y-4">
                                            ...
                                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                                <h5 className="font-semibold text-gray-900 mb-3">Target Markets Analysis</h5>
                                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                    {formData.target_markets.map((market, index) => (
                                                        <div key={index} className="bg-white border border-gray-200 rounded p-3">
                                                            <h6 className="font-medium text-gray-900 mb-2">{market}</h6>
                                                            <div className="text-sm text-gray-600 space-y-1">
                                                                <p>• Privacy regulations compliance</p>
                                                                <p>• Age verification requirements</p>
                                                                <p>• Data localization policies</p>
                                                                <p>• Content moderation standards</p>
                                                            </div>
                                                        </div>
                                                    ))}
                                                </div>
                                            ...
                                            {/* Regulatory Insights */}
                                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                                <h5 className="font-semibold text-gray-900 mb-3">Key Regulatory Insights</h5>
                                                <div className="space-y-3">
                                                    <div className="flex items-start">
                                                        <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                                                        <div>
                                                            <p className="font-medium text-gray-900">Multi-Jurisdiction Compliance</p>
                                                            <p className="text-sm text-gray-600">Feature must comply with varying privacy and data protection standards across target markets</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-start">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-600">Special consideration required for features affecting minors under varying age thresholds</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-start">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-600">Different jurisdictions require varying levels of consent and data processing transparency</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            {/* Compliance Matrix */}
                                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                                <h5 className="font-semibold text-gray-900 mb-3">Compliance Requirements Matrix</h5>
                                                    ...
                                                    <table className="min-w-full divide-y divide-gray-200">
                                                        <thead className="bg-gray-100">
                                                            <tr>
                                                                ...
                                                                <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Privacy Law</th>
                                                                <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Age Verification</th>
                                                        ...
                                                        <tbody className="bg-white divide-y divide-gray-200">
                                                            {formData.target_markets.map((market, index) => (
                                                                <tr key={index}>
                                                                    <td className="px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-900">{market}</td>
                                                                    <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-600">
                                                                        {market === 'US' ? 'CCPA, COPPA' : market === 'EU' ? 'GDPR, DSA' : 'Local Privacy Laws'}
                                                                    </td>
                                                                    <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-600">Required</td>
                            ...
                            <div className="bg-purple-50 border border-purple-200 rounded-lg">
                                <button
                                    className="w-full p-6 text-left focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-inset rounded-t-lg"
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <svg 
                                            className={`w-5 h-5 text-purple-700 transition-transform duration-200 ${accordionState.documentationTrail ? 'rotate-180' : ''}`} 
                                            fill="none" 
                                            stroke="currentColor" 
                                            viewBox="0 0 24 24"
                                        >
                                ...
                                {accordionState.documentationTrail && (
                                    <div className="px-6 pb-6 space-y-4">
                                        <div className="bg-white border border-purple-200 rounded-lg p-4">
                                            <h5 className="font-semibold text-gray-900 mb-3">Analysis Metadata</h5>
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    <span className="font-medium text-gray-600">Analysis ID:</span>
                                                    <p className="text-gray-900 font-mono">{result.result?.feature_id || 'N/A'}</p>
                                                </div>
                                                <div>
                                                    <span className="font-medium text-gray-600">Timestamp:</span>
                                                    <p className="text-gray-900">{result.timestamp || new Date().toISOString()}</p>
                                                </div>
                                                <div>
                                                    <span className="font-medium text-gray-600">Analysis Type:</span>
                                                    <p className="text-gray-900">{result.analysis_type}</p>
                                                </div>
                                                <div>
                                                    <span className="font-medium text-gray-600">Audit Status:</span>
                                                    <p className="text-gray-900">{result.regulatory_inquiry_ready ? 'Ready' : 'Pending'}</p>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="bg-white border border-purple-200 rounded-lg p-4">
                                            <h5 className="font-semibold text-gray-900 mb-3">Processing Trail</h5>
                                            <div className="space-y-2">
                            ...
                            {result.result?.compliance_status && (
                                <div className={`border rounded-lg ${
                                    result.result.compliance_status.risk_level === "HIGH"
                                        ? "bg-red-50 border-red-200"
                                        : result.result.compliance_status.risk_level === "MEDIUM"
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <svg 
                                                className={`w-5 h-5 transition-transform duration-200 ${accordionState.complianceStatus ? 'rotate-180' : ''}`} 
                                                fill="none" 
                                                stroke="currentColor" 
                                                viewBox="0 0 24 24"
                                            >
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    ...
                                                    <p className="text-lg font-semibold text-gray-900 mt-1">
                                                        {result.result.compliance_status.overall_status?.replace(/_/g, " ")}
                                                    </p>
                                                </div>
                                                <div>
                                                    <span className="text-sm font-medium text-gray-600 uppercase tracking-wide">
                                                    ...
                                                    <div className="mt-1">
                                                        <span className={`inline-block px-3 py-1 text-lg font-bold rounded-full ${
                                                            result.result.compliance_status.risk_level === "HIGH"
